...
def main():
    ...
    if args.action == "debug":
        run_debug_checks()
    elif args.action == "data-check":
        run_data_loading_check(data_dir="./Datasets/cifar-10-batches-py", val_size=1000)
    elif args.action == "mx-cache-f4":
        run_mx_cache_check(data_dir="./Datasets/cifar-10-batches-py", val_size=1000, f=4)
    elif args.action == "plot-short":
        plot_short_run_barcharts()
    elif args.action == "plot-long":
        plot_long_training_loss_curves()
    elif args.action == "ex4-no-ls":
        run_exercise4_experiment(label_smoothing=0.0)
    elif args.action == "ex4-ls":
        run_exercise4_experiment(label_smoothing=0.1)
    elif args.action == "plot-ex4":
        plot_exercise4_loss_curves()
